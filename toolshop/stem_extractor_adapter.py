...
def extract_stems(
    ...
    return {
        ...
        "stems": {
            "instrumental": next((p for p in outputs1 if "instrumental" in p.lower()), None),
            "main_vocals": next((p for p in outputs2 if "vocals" in p.lower()), None),
            "backing_vocals": next((p for p in outputs2 if "backing" in p.lower() or "other" in p.lower()), None),
        },
        "models_used": {
            "pass1": model_pass1,
            "pass2": model_pass2
