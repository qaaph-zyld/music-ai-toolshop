...
3. WAIT FOR MY TASK.
4. Call `start_session` MCP tool or run: python scripts/session.py brief "Curate 25-30 photos, crop to 1024x576, write captions with trigger word, package for upload" --files "d:/Project/Video_Ai_Toolshop/dataset/".
...
MY TASK: Curate 25-30 photos, crop to 1024x576, write captions with trigger word, package for upload
