...
3. WAIT FOR MY TASK.
4. Call `start_session` MCP tool or run: python scripts/session.py brief "Assemble processed clips in DaVinci Resolve (free). Add audio (Piper TTS for voiceover, royalty-free music from YouTube Audio Library, Freesound for SFX). Color grade with Shot Match + cinematic LUTs. Export 1080p master + vertical social cuts." --files "d:/Project/Video_Ai_Toolshop/output/final/".
...
MY TASK: Assemble processed clips in DaVinci Resolve (free). Add audio (Piper TTS for voiceover, royalty-free music from YouTube Audio Library, Freesound for SFX). Color grade with Shot Match + cinematic LUTs. Export 1080p master + vertical social cuts.
